...
##
    # 失配
        ...
        data remove storage llib:temp find.move_step
        function llib:easy_str/private/find/get_bad_char_index with storage llib:temp find
        execute if data storage llib:temp find.move_step store result score #right_index temp1 run data get storage llib:temp find.move_step
