##
    ...
    #@score #num : temp1 - 代开方数
#

scoreboard players set #math.559 const 559
scoreboard players set #math.32768 const 32768
...
execute if score #num temp1 matches 0..1515359 run scoreboard players operation #y temp1 /= #math.559 const
execute if score #num temp1 matches 0..1515359 run scoreboard players add #y temp1 15
execute if score #num temp1 matches 1515360.. run scoreboard players operation #y temp1 /= #math.32768 const
...
scoreboard players operation #y temp1 /= #math.2 const
...
scoreboard players reset #math.559 const
scoreboard players reset #math.32768 const
